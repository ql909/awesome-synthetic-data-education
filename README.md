...
## 📄 Papers
### 2026
- Ito, H., Hsu, C.-Y., & Ogata, H. (2026). Cyclic Adaptive Private Synthesis for Sharing Real-World Data in Education. In *LAK26: 16th International Learning Analytics and Knowledge Conference*. ACM. https://doi.org/10.1145/3785022.3785026
  
- Ito, H., Hsu, C.-Y., & Ogata, H. (2026). Training-Free Private Synthesis with Validation: A New Frontier for Practical Educational Data Sharing. *arXiv*. https://doi.org/10.48550/arXiv.2604.01821
  
- Chinodakufa, T. A., Shafin, A. A., & Ahmed, K. M. (2026). Synthetic Data in Education: Empirical Insights from Traditional Resampling and Deep Generative Models. In *The 40th Annual AAAI Conference on Artificial Intelligence: AI4EDU*. https://doi.org/10.48550/arXiv.2604.21031
...
- Agal, S. (2026). A privacy preserving synthetic learner dataset for learning analytics in technology enhanced higher education. *Scientific Reports, 16*, 14772. https://doi.org/10.1038/s41598-026-44990-8
...
- Švábenský, V., Borchers, C., Cloude, E. B., & Shimada, A. (2025). Evaluating the Impact of Data Augmentation on Predictive Model Performance. In *LAK25: The 15th International Learning Analytics and Knowledge Conference*. ACM. https://doi.org/10.1145/3706468.3706485
  
- Iloh, D., Olayinka, O. T., Iyere, F., & Chilakala, S. (2025). Generative Private Synthetic Student Data for Learning Analytics: An Empirical Study. *IEEE Access, 13*, 177345–177351. https://doi.org/10.1109/ACCESS.2025.3619091
  
- Shabnam Ara, S. J., Ramachandriah, T., & Haladappa, M. S. (2025). Predictive model to analyze real and synthetic data for learners’ performance prediction using regression techniques. *Online Learning, 29*(1), 108–131. https://doi.org/10.24059/olj.v29i1.4390
  
- Borchers, C., Thomas, D. R., Lin, J., Abboud, R., & Koedinger, K. R. (2025). Augmenting Human-Annotated Training Data with Large Language Model Generation and Distillation in Open-Response Assessment. In *Proceedings of the Second Workshop on Generative AI for Learning Analytics (GenAI-LA) at LAK25*. https://doi.org/10.48550/arXiv.2501.09126
  
- Zhang, L., Zhang, M., Wang, W. L., & Luo, Y. (2025). Simulation as Reality? The Effectiveness of LLM-Generated Data in Open-ended Question Assessment. *arXiv*. https://doi.org/10.48550/arXiv.2502.06371

### 2024
- Qinyi Liu, Mohammad Khalil, Ronas Shakya, and Jelena Jovanovic. 2024. Scaling While Privacy Preserving: A Comprehensive Synthetic Tabular Data Generation and Evaluation in Learning Analytics. In The 14th Learning Analytics and Knowledge Conference (LAK ’24), March 18–22, 2024, Kyoto, Japan. ACM, New York, NY, USA, 12 pages. https://doi.org/10.1145/3636555.3636921
...
- Yan, L., Martinez-Maldonado, R., & Gašević, D. (2024). Generative artificial intelligence in learning analytics: Contextualising opportunities and challenges through the learning analytics cycle. In *Proceedings of the 14th Learning Analytics and Knowledge Conference*. Association for Computing Machinery.
  
### 2023
- Chen Zhan, Oscar Blessed Deho, Xuwei Zhang, Srecko Joksimovic, and Maarten de Laat. 2023. Synthetic data generator for student data serving learning analytics: A comparative study. Learning Letters 1, 5 (2023), 5–5. DOI: https://doi.org/10.59453/KHZW9006

### 2022
- Jill-Jênn Vie, Tomas Rigaux, and Sein Minn. 2022. Privacy-Preserving Synthetic Educational Data Generation. In Springer eBooks, 393–406. DOI: https://doi.org/10.1007/978-3-031-16290-9_29
...
### 2021
- Peter Bautista and Paul Salvador Inventado. 2021. Protecting Student Privacy with Synthetic Data from Generative Adversarial Networks. Springer eBooks (2021), 66–70. DOI: https://doi.org/10.1007/978-3-030-78270-2_11

### 2020 and before
- Alan M. Berg, Stefan T. Mol, Gábor Kismihók, and Niall Sclater. 2016. The role of a reference synthetic data generator within the field of learning analytics. Journal of Learning Analytics 3, 1 (2016), 107–128. DOI: https://doi.org/10.18608/jla.2016.31.7
  
- Mohsen Dorodchi, Erfan Al-Hossami, A L Benedict, and Elise Demeter. 2019. Using Synthetic Data Generators to Promote Open Science in Higher Education Learning Analytics. In 2019 IEEE International Conference on Big Data (Big Data). DOI: https://doi.org/10.1109/bigdata47090.2019.9006475
---
## 📰 Blog Posts
